...
public class SignalingController {
    ...
    public String handleOffer(@Payload String offer, @DestinationVariable("roomId") String roomId, @DestinationVariable("camKey") String camKey) {
        log.info("handleOffer: camKey: {}, roomId: {}, offer: {}", camKey, roomId, offer);
        return offer;
    }
